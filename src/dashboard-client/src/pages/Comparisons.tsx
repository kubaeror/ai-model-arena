  ...
  return (
    <div className="p-6 space-y-5">
      ...
      {q.isLoading ? (
        ...
        <Panel className="p-6 text-center text-fg-1 text-sm">No runs yet.</Panel>
      ) : (
        [...byScenario.entries()].map(([scenario, recs]) => (
          <div key={scenario}>
            <h2 className="text-sm font-medium text-fg-1 mb-2">{scenario}</h2>
                ...
                <Panel key={r.runId} className="p-3">
                  ...
                  <div className="overflow-auto nice-scroll">
                    <table className="w-full text-xs">
                      <thead>
                        <tr className="text-fg-1 text-left">
